...
# Consumer Blackwell (SM12x, including GB10) has only 101376 bytes of shared
# memory per block. See the num_stages guard below.
_is_sm12x_ = current_platform.is_cuda() and (
...
def _decode_grouped_att_m_fwd(
    ...
    if is_hip_:
        ...
        # MLA with BLOCK_DMODEL=512 and BLOCK_DPE=64 needs 102400 bytes at
        # num_stages=2, exceeding the SM12x limit. num_stages=1 fits.
        num_stages = 1
